...
def download_model():
    """Download and export model to OpenVINO format"""
    model_name = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
    output_dir = os.path.expanduser("~/.cache/tinyllama-openvino")
...
class PDFRAGSystem:
    def __init__(self):
        ...
        self.llm = ov_genai.LLMPipeline(model_path, "CPU")
    ...
    def retrieve_relevant_context(self, query, index, chunks, top_k=3):
        ...
        with torch.no_grad():
            ...
            outputs = self.embed_model(**query_inputs)
